...
export default function Home() {
  ...
  function startExam(examId) {
    ...
    setQuizState(prev => ({ ...prev, selectedExam: exam, view: "selectChapter" }));
  }
  ...
  <div className="mt-2 w-[250px]">
    <PayPalButton hostedButtonId="UTVSMSWXYNFTN" />
  </div>
)}
  </div>
))}
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-6 text-center">
        ...
        {wrongAnswers.length > 0 ? (
          ...
          <p className="text-green-500 font-extrabold text-3xl animate-bounce">Perfect Score! Well done!</p>
        )}
